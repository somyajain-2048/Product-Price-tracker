  ...
  const perks = [
    {
      ...
      label: "Always free",
      desc: "No credit card. No trial period. Just sign up and start tracking.",
    },
    {
      icon: (
        <svg className="w-4 h-4 text-violet-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      desc: "We email you the second a price drops to your target.",
    },
    {
      icon: (
        <svg className="w-4 h-4 text-violet-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export default function Signup() {
  ...
  useEffect(() => {
    document.title = "Create Account | PriceTrack";
  }, []);
